...
public:
  ...
  static std::vector<Event*> build_turn_on_mutation_event(
      const YAML::Node &node, Config* config);

  static std::vector<Event*> build_turn_off_mutation_event(
      const YAML::Node &node, Config* config);

  static std::vector<Event*> build_introduce_plas2_parasite_events(
      const YAML::Node &node, Config* config);

  static std::vector<Event*> build_introduce_aq_mutant_parasite_events(
      const YAML::Node &node, Config* config);

  static std::vector<Event*>
  build_introduce_lumefantrine_mutant_parasite_events(const YAML::Node &node,
                                                      Config* config);

  static std::vector<Event*> build_introduce_mutant_event(
      const YAML::Node &node, Config* config);

  static std::vector<Event*> build_introduce_mutant_raster_event(
      const YAML::Node &node, Config* config);
