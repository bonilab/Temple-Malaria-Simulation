...
public:
  ...
  // Initialize the simulation without parameters, intended for external callers
  // that need access without full features
...
private:
  ...
  // Verify that the configuration is valid, returns true if it is, false
  // otherwise
